...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Beautiful interactive visualization of every skill you have, are learning, and should learn next.",
  },
  {
    icon: Map,
    title: "Personalized Roadmap",
    description:
      "Auto-generated week-by-week plan that adapts as you complete tasks and unlock new skills.",
  },
  {
    icon: Target,
    title: "Job Matching",
    description:
      "Real-time matching against thousands of internships and roles, with the exact gaps to close.",
  },
  {
    icon: Zap,
    title: "Portfolio Builder",
    description:
      "Turn your projects into a stunning portfolio site that recruiters actually remember.",
  },
  {
    icon: Sparkles,
      ...
      <main className="flex-1">
        ...
        <section className="bg-[#FAFAF9]">
          <div className="max-w-5xl mx-auto px-6 pt-24 pb-6 text-center">
            ...
            <p className="mt-6 text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
              Upload your transcript, GitHub and CV. EduMap AI maps your
              skills, spots the gaps, and builds the roadmap to your dream
              role.
            </p>
            ...
            <div className="mt-16 rounded-3xl border border-gray-200 bg-white shadow-sm overflow-hidden">
              <div className="p-8">
                ...
                >
                  {Array.from({ length: GRID_ROWS }).map((_, row) =>
                    Array.from({ length: GRID_COLS }).map((_, col) => (
                      <div
                        key={`${row}-${col}`}
                        className={`h-8 rounded-md ${cellShade(row, col)}`}
                      />
                    ))
                  )}
                </div>
        ...
        <section className="py-14">
          <div className="max-w-5xl mx-auto px-6 flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
            {TRUSTED_LOGOS.map((name) => (
              <span
                key={name}
                className="text-lg text-gray-400 font-medium select-none"
              >
                {name}
              </span>
            ))}
        ...
        <section id="features" className="py-20">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <p className="mt-3 text-gray-500 text-[15px]">
              A complete AI career stack, designed for CS students who don't
              have time to waste.
            </p>

            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 rounded-2xl border border-gray-200 bg-white overflow-hidden">
        ...
        <section id="pricing" className="py-20">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-5 items-stretch">
              {PLANS.map((plan) => {
                  ...
                  {plan.badge && (
                    <span
                      className={`absolute -top-3 ${
                        plan.highlighted
                          ? "left-6 bg-indigo-600 text-white"
                          : "right-6 bg-gray-100 text-gray-700"
        ...
        <section id="faq" className="py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="mt-16 bg-white border border-gray-200 rounded-3xl px-8 py-16 text-center">
              <h3 className="text-3xl font-bold text-gray-900 tracking-tight">
                Ready to map your career?
              </h3>
              <p className="mt-3 text-gray-500 text-[15px] max-w-md mx-auto">
                Join 120,000+ students building the career they actually want
                — in half the time.
              </p>
              <button
                type="button"
